...
class EmailAuthFirebase {
  final firebaseAuth =
      FirebaseAuth.instance; //Objeto que hace referencia a firebaseauth
  ...
  Future<bool> signUpUser(
    ...
    try {
      final credenciales = await firebaseAuth.createUserWithEmailAndPassword(
  ...
  Future<bool> signInUser(
    ...
    bool bandera = false;
    try {
      final credenciales = await firebaseAuth.signInWithEmailAndPassword(
          email: email, password: password);
      if (credenciales.user != null) {
        //Verificacion de que si existe en la base de datos
